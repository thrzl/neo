...
{:then { track, now_playing }}
	<p class="text-lg">{now_playing ? "now playing: ": "recently played"} {cleanTrackString(track.track_name.toRespectfulLowerCase())} — {track.artist_name.toRespectfulLowerCase()}.</p>
{/await}
