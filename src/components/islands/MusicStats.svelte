    ...
    <div class="music-stats">
        <ul class="flex flex-wrap-reverse flex-row gap-0 w-full justify-center">
            {#each [...stats.releases].reverse() as release, i}
                <a href="https://listenbrainz.org/release/{release.release_mbid}" class="order-{i} relative overflow-hidden inline-block min-w-64 grow basis-64 group aspect-ratio-square  duration-300 cursor-help">
                    ...
                    <div class="absolute bg-[--accent-muted-dark] top-0 op-0 group-hover:op-80 scale-95 group-hover:scale-100 duration-200 w-full h-full z-1"></div>
